...
import { GraduationCap, Clock, CreditCard, ChefHat, ArrowRight, Github, Linkedin, Twitter } from 'lucide-react';
      ...
      <header className="relative overflow-hidden pt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            ...
            <Link 
              to="/coming-soon"
              className="bg-purple-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-purple-700 transition-colors duration-200 inline-flex items-center gap-2"
            >
